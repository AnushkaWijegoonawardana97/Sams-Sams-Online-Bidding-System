                        ...
                        <form id="quickForm" novalidate="novalidate" action="{{ route('product_category.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="datetime-local" name="inspection_start_time" class="form-control @error('inspection_start_time') is-invalid @enderror" id="inspection_start_time" placeholder="Enter bid closing date" aria-describedby="inspection_start_time-error" aria-invalid="true" min={{$todaysDate}}>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="datetime-local" name="inspection_end_time" class="form-control @error('inspection_end_time') is-invalid @enderror" id="inspection_end_time" placeholder="Enter bid closing date" aria-describedby="inspection_end_time-error" aria-invalid="true" min={{$todaysDate}}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="inspection_address" class="form-control @error('inspection_address') is-invalid @enderror" id="inspection_address" placeholder="Enter product name" aria-describedby="inspection_address-error" aria-invalid="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="inspection_notes" class="form-control @error('inspection_notes') is-invalid @enderror" id="inspection_notes" placeholder="Enter product description" aria-describedby="inspection_notes-error" spellcheck="true" cols="20" rows="10"></textarea>
